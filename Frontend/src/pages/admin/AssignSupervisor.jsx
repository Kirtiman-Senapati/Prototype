                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-100 text-slate-500 text-sm uppercase tracking-wider">
                                ...
                                <th className="px-6 py-4 font-medium text-left">Supervisor</th>
                                <th className="px-6 py-4 font-medium min-w-[220px]">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                            {filteredProjects.length === 0 ? (
                                ...
                                filteredProjects.map(p => {
                                    ...
                                    return (
                                        <tr key={p._id} className={`transition hover:bg-slate-50 even:bg-slate-50/40 hover:shadow-[inset_0_1px_0_0_rgba(0,0,0,0.03)] ${p.status === 'Pending' ? 'bg-amber-50/10' : (!isAssigned && p.status === 'Approved' ? 'bg-yellow-50/30' : '')}`}>
                                            ...
                                            <td className="px-6 py-5 align-middle">
                                                <p className="text-sm font-medium text-slate-700 line-clamp-2 max-w-[250px] transition-colors">{p.title}</p>
                                            </td>
                                            ...
                                            <td className="px-6 py-5 align-middle">
                                                {p.status === "Pending" ? (
                                                    ...
                                                    <div className="flex flex-col gap-0.5">
                                                        ...
                                                        <span className="text-xs text-slate-400 pl-3.5">Done</span>
                                                    </div>
                                                ) : p.status === "Rejected" ? (
                                                    <div className="flex flex-col gap-0.5">
                                                        <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-xs text-slate-400 pl-3.5">Proposal rejected</span>
                                                    </div>
                                                ) : (
                                                    isAssigned ? (
                                                        <div className="flex flex-col gap-0.5">
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span className="text-sm font-medium text-slate-800">Assigned</span>
                                                            </div>
                                                            <span className="text-xs text-slate-400 pl-3.5">Done</span>
                                                        </div>
                                                    ) : (
                                                        <div className="flex items-center gap-2">
                                                            <select
                                                                className="flex-1 bg-white border border-slate-200 text-sm rounded-lg px-3 py-2 text-slate-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-slate-300 hover:border-slate-300"
                                                            ...
                                                            <button
                                                                ...
                                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                                                                    isSelected 
                                                                        ? "bg-slate-900 text-white hover:bg-slate-800 hover:shadow-md hover:-translate-y-[1px]" 
