  ...
  return (
    <div className="space-y-8 pb-10">
      {project?.supervisor ? (
        ...
        <>
          <div className="bg-white rounded-xl p-6 border border-slate-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8 shadow-[0_1px_2px_rgba(0,0,0,0.04)] animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-slate-100 text-slate-900 rounded-lg">
                <User size={28} />
              </div>
              <div>
                <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Available Supervisors</h1>
                <p className="text-sm text-slate-500 mt-1">Browse and request a supervisor for your approved project.</p>
              </div>
            </div>
          </div>
                                ...
                                <div className="mt-6 pt-4 border-t border-slate-100 relative z-10">
                                    {hasSentRequest ? (
                                        ...
                                        <button 
                                            ...
                                            className="w-full flex items-center justify-center gap-2 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300 hover:text-slate-900 py-2.5 rounded-xl font-medium transition-all duration-200 shadow-sm"
                                        >
                                            Request Supervisor <ArrowRight size={16} className="text-slate-400 group-hover:text-slate-600 transition-colors" />
                                        </button>
                                    )}
                                </div>
                            </div>
