      ...
      <div className="max-w-2xl mx-auto mt-10">
        <div className="bg-white rounded-xl p-8 md:p-12 text-center border border-slate-200 flex flex-col items-center">
          ...
          <button
            ...
            className="mt-8 bg-slate-900 hover:bg-slate-800 text-white px-8 py-3 rounded-xl font-bold transition-all flex items-center gap-2"
          >
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 flex flex-col items-center text-center">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            <button
              ...
              className="px-4 py-2 font-medium text-sm text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 rounded-xl transition-colors flex-1 sm:flex-none"
              disabled={isLoading}
            >
            ...
            <button
              ...
              className="px-4 py-2 font-medium text-sm text-white bg-slate-800 hover:bg-slate-900 rounded-xl transition-colors flex-1 sm:flex-none"
            >
              Edit Title
            </button>
          </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 transition-all">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              type="text"
              className="w-full px-4 py-3 bg-slate-50 hover:bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-slate-200 transition-all font-medium text-slate-800"
              value={title}
          ...
          <div>
            ...
            {/* text area field */}
            <textarea
              className="w-full px-4 py-3 bg-slate-50 hover:bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-slate-200 transition-all font-medium text-slate-800 min-h-[200px] resize-y"
              value={description}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-100 mt-8">
            ...
            <button
              type="submit"
              className="px-6 py-3 font-bold text-white bg-slate-800 hover:bg-slate-900 text-white rounded-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              disabled={isLoading}
            >
